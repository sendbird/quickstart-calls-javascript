...
export default class AppInfoView extends BaseElement {
  ...
  build() {
    ...
    const applicationName = createLabel({
      ...
      className: `${classes['appInfoLabel']} ${classes['appName']} ${classes['fontNormal']} ${classes['fonrReadOnlyColor']}`
    });
    ...
    const applicationID = createLabel({
      ...
      className: `${classes['appInfoLabel']} ${classes['appInfoIdLabel']} ${classes['fontNormal']} ${classes['fonrReadOnlyColor']}`
    });
